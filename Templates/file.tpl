<div class="file">
  ...
  <TMPL_if avgSpeed>
    <span class="transfer-speed">Średnia prędkość: <b><TMPL_var avgSpeed></b></span><br/>
  </TMPL_if>
  <TMPL_if error>
    <br/>
    <div class="transfer-error">Błąd: <pre><TMPL_var error></pre></div>
  </TMPL_if>
